...
bash make_cluster_for_each_category.sh Output/JSQlParser-useful  "" Output/JSQlParser-never-accessed JSQLParser Clustering-Used-Directories 
bash make_cluster_for_each_category.sh Output/Algorithm-useful  "" Output/Algorithm-never-accessed Algorithm Clustering-Used-Directories
bash make_cluster_for_each_category.sh Output/MavenTestCI-useful  "" Output/MavenTestCI-never-accessed MavenTestCI Clustering-Used-Directories
bash make_cluster_for_each_category.sh Output/jv-fruit-shop-useful  "" Output/jv-fruit-shop-never-accessed jv-fruit-shop Clustering-Used-Directories
bash make_cluster_for_each_category.sh Output/matism-example-project-useful  "" Output/matism-example-project-never-accessed matism-example-project Clustering-Used-Directories
bash make_cluster_for_each_category.sh Output/mcMMO-useful  "" Output/mcMMO-never-accessed mcMMO Clustering-Used-Directories
bash make_cluster_for_each_category.sh Output/pipelines-java-useful  "" Output/pipelines-java-never-accessed pipelines-java Clustering-Used-Directories
bash make_cluster_for_each_category.sh Output/spring-framework-petclinic-useful  "" Output/spring-framework-petclinic-never-accessed spring-framework-petclinic Clustering-Used-Directories
bash make_cluster_for_each_category.sh Output/spring-petclinic-rest-useful  "" Output/spring-petclinic-rest-never-accessed spring-petclinic-rest Clustering-Used-Directories
